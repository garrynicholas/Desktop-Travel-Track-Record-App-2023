 ...
 * @author USER
 */
public class catatan2 extends javax.swing.JFrame {

    private String SQL;
    /**
     * Creates new form catatan2
     */
    public catatan2() {
        initComponents();
        tampil_detail();
...
//            String SQL = "Select * from tb_catatan where id_pengguna='"+label21.getText()+"'";
    ...
    private void initComponents() {
        ...
        caritg = new com.toedter.calendar.JDateChooser();
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(caritg, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(caritg, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel12.setText("NO CATATAN");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("NO CATATAN");

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("NO CATATAN");

        jLabel15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("NO CATATAN");

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel16.setText("NO CATATAN");

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel17.setForeground(new java.awt.Color(255, 255, 255));
        jLabel17.setText("NO CATATAN");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        String tampil = "yyyy-MM-dd";
        SimpleDateFormat format = new SimpleDateFormat(tampil);
        String tanggal1 = String.valueOf(format.format(caritg.getDate()));
        cleanTable();
        String hubung="jdbc:mysql://localhost:3306/db_perjalanan";
        try{
            Class.forName("com.mysql.jdbc.Driver").newInstance();
            Connection con=DriverManager.getConnection(hubung,"root","");
            Statement stt=con.createStatement();
            // String sql = "Select * from tb_catatan WHERE tg_catatan ='"+tanggal1+"'";
            String sql = "Select * from tb_catatan where id_pengguna = '"+
            idpengguna.getText() +"'"
            + "and tg_catatan = '" + tanggal1 + "'";
            ResultSet res= stt.executeQuery(sql);
            while(res.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catatan2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private com.toedter.calendar.JDateChooser caritg;
